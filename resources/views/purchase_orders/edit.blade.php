                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-sm-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="0.0001" name="exchange_rate_used" id="exchangeRate" class="form-control" value="{{ old('exchange_rate_used', $order->exchange_rate_used) }}">
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-sm-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="0.01" name="transport_cost_gnf" id="transportCost" class="form-control" value="{{ old('transport_cost_gnf', $order->transport_cost_gnf) }}">
                                    </div>
                                </div>
                                <div class="col-lg-4 col-sm-6 col-12 po-import-only">
                                    <div class="form-group">
                                        <label>Douane / Dédouanement (GNF)</label>
                                        <input type="number" step="0.01" name="customs_cost_gnf" id="customsCost" class="form-control" value="{{ old('customs_cost_gnf', $order->customs_cost_gnf) }}">
                                    </div>
                                </div>
                                <div class="col-lg-4 col-sm-6 col-12">
                                    <div class="form-group">
                                        <label>Frais divers (GNF)</label>
                                        <input type="number" step="0.01" name="other_fees_gnf" class="form-control" value="{{ old('other_fees_gnf', $order->other_fees_gnf) }}">
                                    </div>
                                </div>
                            </div>

                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-sm-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="reference" value="{{ old('reference', $dette->reference) }}" readonly>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="customer_id" class="form-control" required>
                                                ...
                                                @foreach($customers as $c)
                                                    <option value="{{ $c->id }}" {{ old('customer_id', $dette->customer_id) == $c->id ? 'selected' : '' }}>
                                    ...
                                    <div class="col-lg-4 col-sm-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <select name="store_id" class="form-control" required>
                                                <option value="">— Sélectionner —</option>
                                                @foreach($stores as $s)
                                                    <option value="{{ $s->id }}" {{ old('store_id', $dette->store_id) == $s->id ? 'selected' : '' }}>{{ $s->store_name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-lg-4 col-sm-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="montant_total" min="0" value="{{ old('montant_total', $dette->montant_total) }}" required>
                                        </div>
                                    ...
                                    <div class="col-lg-4 col-sm-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="montant_paid" min="0" value="{{ old('montant_paid', $dette->montant_paid) }}" required>
                                        </div>
                                    ...
                                    <div class="col-lg-4 col-sm-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="endettement_date" value="{{ old('endettement_date', $dette->endettement_date) }}" required>
                                        </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label>Notes</label>
                                            <textarea name="notes" rows="4">{{ old('notes', $dette->notes) }}</textarea>
                                        </div>
